...
go
Alter table [enroll] add  foreign key([User_ID]) references [User] ([User_ID])  on update no action on delete no action 
go
Alter table [assigned_to] add  foreign key([User_ID]) references [User] ([User_ID])  on update no action on delete no action 
go
Alter table [attends] add  foreign key([User_ID]) references [User] ([User_ID])  on update no action on delete no action 
go
...
go
Alter table [enroll] add  foreign key([Class_ID]) references [Class] ([Class_ID])  on update no action on delete no action 
go
...
go
Alter table [assigned_to] add  foreign key([Project_ID]) references [Project] ([Project_ID])  on update no action on delete no action 
go
...
go
Alter table [attends] add  foreign key([Meeting_ID]) references [Meeting] ([Meeting_ID])  on update no action on delete no action 
go
